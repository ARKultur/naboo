defmodule NabooWeb.Errors do
  alias Ecto.Changeset
  alias NabooWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(Naboo.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(Naboo.Gettext, "errors", message, options)
    end
  end
